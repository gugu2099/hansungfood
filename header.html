...
<div id="warpper">
    <header id="header">
        <div id="gnb">
            <div class="aside">
              <h1><a href="#"><img src="image/logo5.png" alt="메인로고"></a></h1>
              <nav class="a-group">
                <ul class="aside-01">
                    <li><a href="">KR</a></li>
                    <li><a href="">CHI</a></li>
              ...
              <div id="slider">
                ...
                <nav class="nav-list">
                    <h1 class="nav-logo">
                        <img src="image/logo5.png" alt="한성푸드로고">
                    </h1>
                    <div class="depth-01">
                        <input type="checkbox" id="side">
                        <label for="side" class="side-01">기업소개</label>
                        <ul class="top1">
                            <li><a href="subpage1/index.html">한성푸드</a></li>
                            <li><a href="subpage2/index.html">CEO 인사말</a></li>
                            <li><a href="subpage3/index.html">연혁</a></li>
                        ...
                        <label for="side1" class="side-01">공장소개</label>
                          <ul class="top2">
                            <li><a href="subpage10/index.html">제 1 & 2공장</a></li>
                            <li><a href="subpage11/index.html">Capacity</a></li>
                            <li><a href="subpage12/index.html">품질관리</a></li>
                        ...
                        <label for="side2" class="side-01">제품소개</label>
                        <ul class="top3">
                            <li><a href="subpage20/index.html">액상차</a></li>
                            <li><a href="subpage21/index.html">과즙·당절임</a></li>
                            <li><a href="">기타제품</a></li>
                        </ul>
                        <div class="top4"><a href="../subpage30/index.html">상담문의</a></div>
                    </div>
                </nav>
            </div>
            </div>
